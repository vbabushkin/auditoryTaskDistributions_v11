...
public class InstructionsPanel7 extends JPanel{
	
	public InstructionsPanel7(){
	    ...
	    String lblMessage = String.format("<html><center>Now you'll get to practice placing some guesses.<br>"
	    		+ "There is no correct response here. Scroll to change the pitch of the tone<br>"
	    		+ "and lock in a response by clicking the mouse<br><br>"
	    		+ "Enter %d different responses.<br>"
