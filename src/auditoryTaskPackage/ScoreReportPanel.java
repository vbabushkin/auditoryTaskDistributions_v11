...
import auditoryTaskPackage.ProbePanel.SmoothSoundGenerator;
...
public class ScoreReportPanel extends JPanel{
	...
	public ScoreReportPanel(){
		...
		//setLayout(new BorderLayout(10,10)); 
				...
				message = String.format("<html><center>Please compare your <font  color=\"#505050\">response</font > vs. the  <font  color=\"#00E600\"> actual tone</font>.</center></html>"
		    			 ,(int)cummulativeScorePerTrial,tempMsg, (currentTrial+1)
		    			);
			...
			public void paintComponent(Graphics g) {
				...
				g.drawLine(xPixToTrim/2, verticalIdent-(Parameters.HEIGHT_ADJUSTMENT_FOR_GAUSSIAN+1), w-xPixToTrim/2, verticalIdent-(Parameters.HEIGHT_ADJUSTMENT_FOR_GAUSSIAN+1));
				 ...
				 //if(RunExperimentWindow.currentBet!=0){
				    ...
				    g.fillPolygon(ProbePanel.p.xpoints, ProbePanel.p.ypoints, ProbePanel.p.npoints);
				    if(showTrigger){
