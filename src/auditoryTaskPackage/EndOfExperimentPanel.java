...
public class EndOfExperimentPanel extends JPanel{
	
	public EndOfExperimentPanel(){
	    ...
	    String lblMessage = String.format("<html><center>The experiment is over.<br><br>Thank you for participation!<br><br>Click the mouse  to exit.</center></html>");
