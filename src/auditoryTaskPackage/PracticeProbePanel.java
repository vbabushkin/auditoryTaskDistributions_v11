...
public class PracticeProbePanel extends JComponent {
	...
	//public PrintWriter tmOut; 
	public static double maxScore;
	
    public PracticeProbePanel(){
//    	 try {
// 			//tmOut = new PrintWriter(new BufferedWriter(new FileWriter(new String(RunExperimentWindow.resDirectory +"//"+AdvancedOptionsWindow.studyId+"//"+ExperimentSetupWindow.subNum+"//out_"+RunExperimentWindow.currentPracticeTrial+"_"+RunExperimentWindow.currentBet+".txt"), true)));
// 		} catch (IOException e) {
// 			// TODO Auto-generated catch block
// 			e.printStackTrace();
// 		}
// 		 tmOut.printf("%s %s%n","x","mixSum"); 
    	//setSize(Main.screenWidth-200, 620);
    	setLayout(new BorderLayout(10,10));
    	String message = "";
    	
    	//if it is not the first trial
    	if(!RunExperimentWindow.trainingBetsSection){
    		 message = String.format("<html><center>Guess # %d <br>"
    		 ...
    		 message = String.format("<html><center>Guess # %d <br>"
	    			 + "Please swipe the touchpad or move the mouse to adjust the pitch.<br><br><br></center></html>"
	    			 ,(RunExperimentWindow.currentBet)
	    			);
    	}
...
//   	 	}
   	 	...
   	 	if(RunExperimentWindow.currentPracticeTrial>0){
   	 		g.drawLine(xPixToTrim/2, verticalIdent-(Parameters.HEIGHT_ADJUSTMENT_FOR_GAUSSIAN+1), w-xPixToTrim/2, verticalIdent-(Parameters.HEIGHT_ADJUSTMENT_FOR_GAUSSIAN+1));
   	 	}
