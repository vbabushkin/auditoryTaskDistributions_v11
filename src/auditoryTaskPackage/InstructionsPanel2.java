...
public class InstructionsPanel2 extends JPanel{
	...
	public InstructionsPanel2(){
	    ...
	    String lblMessage = String.format("<html><center>This game tests your memory for sounds.<br><br>"+
	    					"It is made up of %d trials and will last around 20 minutes.<br><br>"+
	    					"Click the mouse to continue.</center></html>", AdvancedOptionsWindow.numTrials);
