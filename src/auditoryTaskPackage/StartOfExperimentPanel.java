...
public class StartOfExperimentPanel extends JPanel{
	
	public StartOfExperimentPanel(){
	    ...
	    String lblMessage = String.format("<html><center>Click the mouse to begin.<br><br> Good luck!</center></html>");
