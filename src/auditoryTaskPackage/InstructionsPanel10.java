...
public class InstructionsPanel10 extends JPanel{
	
	public InstructionsPanel10(){
	    ...
	    String lblMessage = String.format("<html><center>You'll only have %d seconds to place each guess, so don't take too long with your guesses.<br>"
	    		+ "Click the mouse to continue.</center></html>", ((int)AdvancedOptionsWindow.probeDuration/1000));
