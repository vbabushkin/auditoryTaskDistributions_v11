...
public class InstructionsPanel3 extends JPanel{
	...
	public InstructionsPanel3(){
	    ...
	    String lblMessage = String.format("<html><center>Each trial will begin with a cross and circle in the center of the screen.<br>"+
	    		"Keep your gaze focused on this cross/circle whenever you see them on the screen.<br><br>"+
